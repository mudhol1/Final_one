...
urlpatterns = [
    ...
    path("subject/edit/<int:subject_id>",
     ...
     path("gen_pdf/<int:pk>",views.stu_pdf,name='stu_pdf'),
    ...
    path("delete/<int:Ach_id>",
         hod_views.delete_Ach, name='delete_ach'),
    ...
    path('student/view/search_but/', staff_views.search_but,
         name='search_but'),
    path('student/view/search_stud/', staff_views.search,
         name='search_stud'),
 path('student/view/Add/', student_views.stud_form,
        name='Add'),
     path('student/view/edit/', hod_views.edit_form,
        name='edit'),
path('student/view/manage/', hod_views.manage_achieve,
        name='manage'),
path('student/view/update/<int:pk>', hod_views.update_form,
        name='update'),

path('admin_upload/',views.simple_upload,name='upload'),
