...
def stu_pdf(request,pk):
    ...
    a=Achieve.objects.get(id=pk)
    
    k=1
    lines.append(k)
    lines.append(a.student)
    lines.append(a.Student_Details)
    ...
    return FileResponse(buf,as_attachment=True,filename='stud.pdf')
